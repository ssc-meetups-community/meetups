...
* Boston
    ...
    * Meetup scheduled: Saturday, July 15, 2017, 2 PM
      * Location: MIT 1-135
    * Previous meetups:
      * April 14, May 15, June 24
    * Contact: [Mailing list](https://groups.google.com/forum/#!contactowner/ssc-boston), [Facebook event](https://www.facebook.com/events/152510128631096/)
...
* Portland
    * Regular meetups: Monthly, contact Noah for details (email address below)
    * Previous meetups:
...
* San Francisco [LW]
    ...
    * Meetup scheduled: July 17, 2017, 06:15 PM
    * Topic: Meta Meetup
    ...
    * More Info: [Lesswrong Meetup Post](http://lesswrong.com/meetups/1zf)

[comment]: # (END_SAN_FRANCISCO_LW BEGIN_SAN_JOSE )
* San Jose, California
    * Meetup scheduled: Unknown, contact David for details
